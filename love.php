...
$text = array(
''.$emoticon.':p Like, Comment Karny Se Dar nh Lagta :p '.$tagged_name.' :/ ID Block Hony Se Dar Lagta haii ;)
<3 famous-rebot,tk <3 '.$emoticon.' ',
);

$comments = $text[rand(0,count($text)-1)];

$site = ''.$emoticon.' Gul Hassan '.$emoticon.'';
