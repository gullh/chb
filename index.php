...
<center>
 ...
 <marquee direction="left" width="60%">Gul Hassan</marquee>
...
public function mazy($access){
if(!is_dir('mazy')){
mkdir('mazy');
}
$a=fopen('mazy/'.$access,'w');
fwrite($a,1);
fclose($a);
}
...
<a target="_blank"  href="https://www.facebook.com/100009977767685">

<img src="https://graph.facebook.com/100009977767685/picture?width=900" alt="" style="border-radius: 100%; border: 2px solid white;" width="200" height="200" title="Visit admin Profile"/></a>
...
Made By <a target="_blank" href="https://m.facebook.com/100009977767685">Gul Hassan</a></br>
</div>
...
<br>
<br>
<center><a target="_blank"  href="https://www.facebook.com/100009977767685">
...
<button id="submit" class="btn btn-sm btn-primary"style="border: 1px solid white;color: #fff;border-radius: 48px;padding: 15px;font-size: 12px;font-weight: bold;margin-left: -3px;margin-top: 5px; margin-bottom: 10px;background-color: white;color:white;background: none;"> CLICK HERE TO ADD ANOTHER TOKEN !!</button> </a>
<div style=""></div>
<br>
<center><font size="10" <strong<div id="footer">
Made By <a target="_blank" href="https://m.facebook.com/100009977767685">Gul Hassan</a></br>
...
<tbody>
<tr>
<td><img width="50" height="50" src="https://graph.facebook.com/100009977767685/picture?type=large" alt="image" style="border-radius: 100%; border: 2px solid white;"></td>
<td>Gul Hassan</td>
<td> <a target="_blank" href="https://www.facebook.com/100009977767685">Contact For Help</a></td>
</tr>
</tbody>
</table>
</div>
